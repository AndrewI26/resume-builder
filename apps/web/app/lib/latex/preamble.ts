 ...
 * generated. The template's spacing is a pile of hand-tuned `\vspace` nudges
 * and macro definitions that carry no data; modelling them would buy nothing
 * and would drift from the original. Only the body below it is generated.
 *
